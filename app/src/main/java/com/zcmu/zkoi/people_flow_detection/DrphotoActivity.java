...
@ContentView(R.layout.activity_drphoto)
public class DrphotoActivity extends AppCompatActivity {
...
//            }else
//                result = msg.toString();
            Toast.makeText(DrphotoActivity.this,msg.toString(),Toast.LENGTH_SHORT).show();
        }
    };
...
//    };
    ...
    public void takephoto(){
        ...
        if(Build.VERSION.SDK_INT>=24){
            uri = FileProvider.getUriForFile(DrphotoActivity.this,"com.zcmu.zkoi.paddlepaddle",outImage);
            uri1 = uri.toString();
        }
...
//        params.addBodyParameter("longitude",String.valueOf(longitude));
    ...
    @Event(type = View.OnClickListener.class,value = {R.id.btn_upload,R.id.btn_retake})
    private void OnClick(View view) throws URISyntaxException{
        switch(view.getId()){
            case R.id.btn_upload:
//                photoUp(url);
                Toast.makeText(DrphotoActivity.this,"上传成功",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(DrphotoActivity.this,diningRoom_Activity.class);
